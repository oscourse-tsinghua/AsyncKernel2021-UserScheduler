...
pub enum Event {
    ...
    ReadBuf(usize,String,u64,Arc<Mutex<String>>),
...
impl Reactor {
                ...
                match event {
                    ...
                    Event::ReadBuf(id,file_name,position,result) => {
                        ...
                        let event_handle = thread::spawn(move || {
                            println!("read {} start   {}",file_name,start.elapsed().as_secs_f64());
                            // 打开文件
                            ...
                            result.lock().map(|mut r| {
                                ...
                                unsafe {
                                    ...
                                    match len {
                                        0 => *r = String::from(""),
                                        _ => *r = String::from_utf8(buffer.to_vec()).unwrap(),
                                    }
                                }
                            }).unwrap();
                            
                            println!("read {} finish  {}",file_name,start.elapsed().as_secs_f64());
     ...
     */
     #[allow(unused_must_use)]
    pub fn register_buffer(&mut self,id: usize,waker: Waker,file_name:String,position:u64,buffer:Arc<Mutex<String>>){
